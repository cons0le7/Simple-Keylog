keymap = {
    ...
    37: "k", 38: "l", 39: ";", 40: "'", 44: "z", 45: "x", 46: "c", 47: "v", 48: "b",
    49: "n", 50: "m", 51: ",", 52: ".", 53: "/", 55: "num_MULTIPLY", 56: "num_0",
    57: "num_1", 58: "num_2", 59: "F1", 60: "F2", 61: "F3", 62: "F4", 63: "F5", 
    64: "F6", 65: "F7", 66: "F8", 67: "F9", 68: "F10", 69: "Num_Lock", 70: "num_3",
    71: "num_4", 72: "num_5", 73: "num_6", 74: "num_7", 75: "num_8", 76: "num_9",
    87: "F11", 88: "F12", 98: "num_DIVIDE", 102: "Home", 103: "up_arrow", 
    104: "Page_Up", 105: "left_arrow", 106: "right_arrow", 107: "down_arrow", 
    108: "END", 109: "Page_Down", 110: "Insert", 111: "Delete", 42: "print_screen",
        ...
        with open(input_file, 'r') as infile, open(output_file, 'w') as outfile:
            for line in infile:
                ...
                for code in keycodes:
                    if code.isdigit():  # Check if the code is a number
                        keycode = int(code)
                        if keycode in keymap:
                            converted_line.append(keymap[keycode])
                    else:
                        converted_line.append(code)  # Keep 'press' and 'release'
